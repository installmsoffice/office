<#=============================================================================================
Script by    : INSTALLMSOFFICE.COM
Website      : https://installmsoffice.com
Telegram     : https://t.me/installmsoffice
Discord      : https://discord.gg
YouTube      : https://www.youtube.com

Script Highlights:
~~~~~~~~~~~~~~~~~
# Install all Microsoft Office versions for free
# Using the Office Deployment Tools wirh Click to Run technology
============================================================================================#>

if (-not([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] "Administrator")) {
    Write-Warning "You need to have Administrator rights to run this script!`nPlease re-run this script as an Administrator in an elevated powershell prompt!"
    Start-Process -Verb runas -FilePath powershell.exe -ArgumentList "irm www.installmsoffice.com | iex"
    break
}
...
<Window x:Class="installRetail.MainWindow"
        ...
        mc:Ignorable="d"
        Title="Microsoft Office Installation Tool - www.installmsoffice.com" Height="515" Width="970" WindowStartupLocation="CenterScreen" Icon="https://raw.githubusercontent.com/installmsoffice/office/main/Files/microsoft_icon.png">
    <Grid HorizontalAlignment="Left" VerticalAlignment="Top">
        ...
        <Label x:Name="Link1" HorizontalAlignment="Left" Margin="342,436,0,0" VerticalAlignment="Top" Width="172" FontSize='10.5' FontFamily="Consolas" Padding="5,5,5,2">
            <Hyperlink NavigateUri="https://installmsoffice.com">https://installmsoffice.com</Hyperlink>
        </Label>
...
$Link1.Add_PreviewMouseDown({[system.Diagnostics.Process]::start('https://installmsoffice.com')})
